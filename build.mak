export PJDIR := /Volumes/WORK/PJSIP/pjproject-2.1.0
...
export APP_CC := /Applications/Xcode_5.app/Contents/Developer/usr/bin/gcc
export APP_CXX := /Applications/Xcode_5.app/Contents/Developer/usr/bin/g++
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-O2 -m32 -miphoneos-version-min=5.0 -g -ggdb -g3 -DNDEBUG -DPJ_SDK_NAME="\"iPhoneOS7.0.sdk\"" -arch armv7s -isysroot /Applications/Xcode_5.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS7.0.sdk -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
	$(PJ_VIDEO_CFLAGS) \
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	-O2 -m32 -arch armv7s -isysroot /Applications/Xcode_5.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS7.0.sdk -framework AudioToolbox -framework Foundation
export APP_LDLIBS := -lpjsua-$(TARGET_NAME)\
	...
	$(APP_THIRD_PARTY_EXT)\
	-lpj-$(TARGET_NAME)\
	-lm -lpthread  -framework CoreAudio -framework CoreFoundation -framework AudioToolbox -framework CFNetwork -framework UIKit -framework UIKit
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-O2 -m32 -miphoneos-version-min=5.0 -g -ggdb -g3 -DNDEBUG -DPJ_SDK_NAME="\"iPhoneOS7.0.sdk\"" -arch armv7s -isysroot /Applications/Xcode_5.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS7.0.sdk -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
